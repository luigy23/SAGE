...
import { rehabilitarAgendaAction } from "@/lib/actions/revision"
...
export function RehabilitarAgendaDialog({
  ...
  function handleSubmit() {
    startTransition(async () => {
      const res = await rehabilitarAgendaAction(
        agendaId,
        motivo,
        observaciones || null,
      )
          ...
          <div className="flex items-start gap-2 rounded-md border border-yellow-300 bg-yellow-50 p-3 text-sm dark:border-yellow-800 dark:bg-yellow-950">
            ...
            <div className="text-yellow-900 dark:text-yellow-200">
              ...
              <p className="mt-1 text-xs">
                La agenda volverá a <span className="font-mono">BORRADOR</span> y el
                docente podrá editarla. El motivo, fecha y tu identidad quedan
