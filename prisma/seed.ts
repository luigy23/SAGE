...
const parametrosGlobales = [
  {
    ...
    valor: "22",
    tipo: "int",
    descripcion: "Semanas por período académico (PLANTA — base 880/440)",
    articuloOrigen: "Acuerdo 048/2018 Art. 4",
  },
  {
    clave: "semanas_periodo_catedra",
    valor: "16",
    tipo: "int",
    descripcion: "Semanas por defecto para profesores de cátedra",
    articuloOrigen: "Acuerdo 048/2018 Art. 4d",
  },
  {
    clave: "semanas_periodo_ocasional",
    valor: "16",
    tipo: "int",
    descripcion: "Semanas por defecto para ocasionales (fallback si no hay fechas de contrato)",
    articuloOrigen: "Acuerdo 048/2018 Art. 4c",
  },
  {
    clave: "semanas_periodo_visitante",
    valor: "16",
    tipo: "int",
    descripcion: "Semanas por defecto para visitantes y cátedra visitante (fallback si no hay fechas de contrato)",
    articuloOrigen: "Acuerdo 048/2018 Art. 4e",
  },
  {
    clave: "semanas_clases",
    valor: "16",
    tipo: "int",
    descripcion: "Semanas de clase por defecto para el cálculo de horas de los cursos (independiente de las semanas del contrato)",
