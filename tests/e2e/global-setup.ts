...
export default async function globalSetup() {
  ...
  const demoProc = await prepararEscenarioDemoProcesos()
  console.log("[global-setup] escenarios listos:", { mbc, calc, mods, consej, consejVista, invitado, proyIny, demo, demoProc })
}
